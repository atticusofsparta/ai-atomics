...
function Connect() {
  ...
  return <Button variant={walletAddress ? 'outline' : 'solid'} onClick={() => !walletAddress ? handleConnect() : handleDisconnect()}>{walletAddress ? walletAddress.slice(0,5) + '...' : "Connect"}</Button>;
}
